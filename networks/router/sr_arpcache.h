...
/* =====================================================
  sr_arp_make_packet
  Allows us to make an ARP packet, we can determine if the
  packet is a reply or request by setting the mode to 0
  or 1, respectively.
   ===================================================== */
...
/* =====================================================
  sr_arp_request
  Allows us to make and send an ARP request packet,
  given the instance and target IP.
   ===================================================== */
